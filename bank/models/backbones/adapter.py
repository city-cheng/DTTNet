...
class SemanticAdapter(nn.Module):
    ...
    def forward(
        ...
        # print(
        #     f"identity:{identity.shape},shadow_feat:{shadow_feat.shape},bg_feat:{bg_feat.shape}"
        # )
        feats = identity + self.up(
            self.shadow_scale * shadow_feat + self.bg_scale * bg_feat
        )  # feats: bt,N,1024

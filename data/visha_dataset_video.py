...
class ViSha_Dataset(Dataset):
    def __init__(self, mode: str, config: dict) -> None:
        ...
        if self.is_training:
            file_path = self.data_root + "/train/descriptions.json"
            print("***********************Loading JSON file:", file_path)
        else:
            file_path = self.data_root + "/test/descriptions.json"
            print("***********************Loading JSON file:", file_path)
    ...
    def __getitem__(self, index):
        ...
        clip_list, label_list, boundary_list = self.joint_transform(
            clip_list, label_list, boundary_list
        )
